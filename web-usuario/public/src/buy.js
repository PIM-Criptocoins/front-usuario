...
const buyPrice = query("#buy-price");
let price = 0;
...
submit.addEventListener("click", () =>{
  ...
  } else if(buyPrice.value > parseInt(localUser.balance)){
    return alert("Você não pode comprar essa quantidade de criptomoedas");
  } else {
    const totalBalance = localUser.balance - buyPrice.value;
